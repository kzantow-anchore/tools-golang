...
func TestSaver2_2DocumentSavesText(t *testing.T) {
	...
	f3 := &v2_22.File{
		...
		FileCopyrightText: "Copyright (c) Jane Doe",
		Snippets: map[common.ElementID]*v2_22.Snippet{
