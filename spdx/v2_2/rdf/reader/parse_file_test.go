...
func Test_rdfParser2_2_setUnpackagedFiles(t *testing.T) {
	...
	rdfParser, _ := parserFromBodyContent(``)
	file1 := &v2_2.File{FileSPDXIdentifier: common2.ElementID("file1")}
	file2 := &v2_2.File{FileSPDXIdentifier: common2.ElementID("file2")}
	file3 := &v2_2.File{FileSPDXIdentifier: common2.ElementID("file3")}
