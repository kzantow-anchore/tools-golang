...
func (parser *rdfParser2_2) setSnippetToFileWithID(snippet *v2_2.Snippet, fileID common2.ElementID) error {
	...
	if parser.files[fileID].Snippets == nil {
		parser.files[fileID].Snippets = map[common2.ElementID]*v2_2.Snippet{}
	}
