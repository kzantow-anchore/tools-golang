...
type Package struct {
	...
	// Cardinality: mandatory, one
	PackageSPDXIdentifier spdx.ElementID `json:"SPDXID"`
	...
	//                        or NOASSERTION
	// Cardinality: optional, one
	PackageSupplier *spdx.Supplier `json:"supplier,omitempty"`

	// 7.6: Package Originator: may have single result for either Person or Organization,
	//                          or NOASSERTION
	// Cardinality: optional, one
	PackageOriginator *spdx.Originator `json:"originator,omitempty"`
	...
	PackageVerificationCode *spdx.PackageVerificationCode `json:"packageVerificationCode,omitempty"`
	...
	PackageChecksums []spdx.Checksum `json:"checksums,omitempty"`
