...
func ParseTagValues(tvs []tv.TagValuePair) (*v2_3.Document, error) {
	parser := tvParser2_3{}
	for _, tv := range tvs {
...
func (parser *tvParser2_3) parsePair(tag string, value string) error {
	switch parser.st {
	case psStart2_3:
...
func (parser *tvParser2_3) parsePairFromStart(tag string, value string) error {
