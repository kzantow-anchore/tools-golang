...
func (parser *rdfParser2_3) setSnippetToFileWithID(snippet *v2_3.Snippet, fileID spdx.ElementID) error {
	...
	if parser.files[fileID].Snippets == nil {
		parser.files[fileID].Snippets = map[spdx.ElementID]*v2_3.Snippet{}
	}
