...
func (parser *rdfParser2_2) setSnippetToFileWithID(snippet *v2_2.Snippet, fileID spdx.ElementID) error {
	...
	if parser.files[fileID].Snippets == nil {
		parser.files[fileID].Snippets = map[spdx.ElementID]*v2_2.Snippet{}
	}
