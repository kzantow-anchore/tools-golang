...
func TestParser2_2PackageStartsNewPackageAfterParsingPackageNameTag(t *testing.T) {
	...
	parser := tvParser2_2{
		...
		st:  psPackage2_2,
		pkg: &v2_22.Package{PackageName: pkgOldName, PackageSPDXIdentifier: "p1"},
	}
	pkgOld := parser.pkg
...
func TestParser2_2PackageMovesToFileAfterParsingFileNameTag(t *testing.T) {
	parser := tvParser2_2{
		doc: &v2_22.Document{Packages: []*v2_22.Package{}},
		st:  psPackage2_2,
		pkg: &v2_22.Package{PackageName: "p1", PackageSPDXIdentifier: "p1"},
	}
...
func TestParser2_2PackageWithoutSpdxIdentifierThrowsError(t *testing.T) {
	...
	parser := tvParser2_2{
		doc: &v2_22.Document{Packages: []*v2_22.Package{}},
		st:  psPackage2_2,
		pkg: &v2_22.Package{PackageName: pkgOldName},
	}
	pkgOld := parser.pkg
	parser.doc.Packages = append(parser.doc.Packages, pkgOld)
	// the Document's Packages should have this one only
