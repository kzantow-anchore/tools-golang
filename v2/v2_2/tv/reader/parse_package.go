...
func (parser *tvParser2_2) parsePairFromPackage(tag string, value string) error {
	...
	case "SPDXID":
		...
		if parser.doc.Packages == nil {
			parser.doc.Packages = []*v2_22.Package{}
		}
	...
	case "ExternalRef":
		parser.pkgExtRef = &v2_22.PackageExternalReference{}
