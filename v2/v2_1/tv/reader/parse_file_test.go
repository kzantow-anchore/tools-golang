...
func TestParser2_1FileStartsNewFileAfterParsingFileNameTag(t *testing.T) {
	...
	parser := tvParser2_1{
		...
		file: &v2_12.File{FileName: fileOldName, FileSPDXIdentifier: "f1"},
	}
	fileOld := parser.file
...
func TestParser2_1FileStartsNewPackageAfterParsingPackageNameTag(t *testing.T) {
	...
	parser := tvParser2_1{
		doc:  &v2_12.Document{Packages: []*v2_12.Package{}},
		st:   psFile2_1,
		pkg:  &v2_12.Package{PackageName: p1Name, PackageSPDXIdentifier: "package1", Files: []*v2_12.File{}},
		file: &v2_12.File{FileName: f1Name, FileSPDXIdentifier: "f1"},
	}
	p1 := parser.pkg
	f1 := parser.file
...
func TestParser2_1FileMovesToSnippetAfterParsingSnippetSPDXIDTag(t *testing.T) {
	parser := tvParser2_1{
		...
		st:   psFile2_1,
		pkg:  &v2_12.Package{PackageName: "test", PackageSPDXIdentifier: "test", Files: []*v2_12.File{}},
		file: &v2_12.File{FileName: "f1.txt", FileSPDXIdentifier: "f1"},
	}
	parser.doc.Packages = append(parser.doc.Packages, parser.pkg)
