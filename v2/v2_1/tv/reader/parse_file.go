...
func (parser *tvParser2_1) parsePairFromFile(tag string, value string) error {
	...
	case "ArtifactOfProjectName":
		parser.fileAOP = &v2_12.ArtifactOfProject{}
