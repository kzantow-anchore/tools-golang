...
func ParseTagValues(tvs []tv.TagValuePair) (*v2_1.Document, error) {
	parser := tvParser2_1{}
	for _, tv := range tvs {
...
func (parser *tvParser2_1) parsePair(tag string, value string) error {
	switch parser.st {
	case psStart2_1:
...
func (parser *tvParser2_1) parsePairFromStart(tag string, value string) error {
